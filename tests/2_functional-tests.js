        ...
        chai.request(server)
          ...
          .end(function(err2, res2) {
            ...
            assert.equal(
              ...
              firstLikes,
              'Liking the same stock twice from the same IP should not increase the like count'
            );
            done();
          });
      });
  ...
  test('Viewing two stocks and liking them: GET request to /api/stock-prices/', function(done) {
    chai.request(server)
      ...
      .end(function(err, res) {
        ...
        assert.equal(
          first.rel_likes + second.rel_likes,
          0,
          'rel_likes should be equal and opposite between the two stocks'
        );
        done();
      });
  });
